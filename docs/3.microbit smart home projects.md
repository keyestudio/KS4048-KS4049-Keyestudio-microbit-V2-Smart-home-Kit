...
Download the code (for Windows 10 App, click to download code; for browsers, download the "hex" file and sent it to the micro: bit board) and power on via micro USB cable. The 6812 RGB module lights up in red, yellow, blue, purple and white. Each colour remains 1 second and this sequence repeats.
...
| micro:bit board *1   | ![microbitV2](img/microbitV2.png) |
| micro USB cable *1   | ![usb](img/usb.png)               |
| Ultrasonic sensor *1 | ![KS0504](img/KS0504.png)         |
...
<span style="background:#ff0;color:#000">Note that when installing, please keep the cross arm horizontal to the servo.</span>

Mount the arm gently on the servo and do not rotate the servo. 

![ss](img/ss.png)

<span style="background:#ff0;color:#000">If they cannot align with each other, as shown above, rotate 90° each time until they can.</span>



<span style="background:#ff0;color:#000">Gently remove the cross arm after it aligns with the servo, and install the cross arm on the door according to this orientation, as shown in the picture below:</span>
...
Take out the materials as shown below.
...
Connect the 4-PIN wire to the ultrasonic module as shown below.
...
Connect the 4-PIN wire to the fan.
...
![99_104](img/99_104.png)

![99_105](img/99_105.png)

![99_106](img/99_106.png)

![99_107](img/99_107.png)

#### 9. Wire up the rest of modules

![99_100](img/99_100.png)

![99_101](img/99_101.png)

![99_102](img/99_102.png)

![99_103](img/99_103.png)
...
Download the code (for Windows 10 App, click to download code; for browsers, download the "hex" file and sent it to the micro: bit board) and power on via micro USB cable. If the sensor detects that the house tilts, print the Y-axis value on the LCD, the speaker alarms, and the RGB lights up in red.
